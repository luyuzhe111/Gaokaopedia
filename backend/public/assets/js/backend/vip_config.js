define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'vip_level', title: __('Vip_level'), searchList: {"1":__('Vip_level 1'),"2":__('Vip_level 2')}, formatter: Table.api.formatter.normal},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'vip_config/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
