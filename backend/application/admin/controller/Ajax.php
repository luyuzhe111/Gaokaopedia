...
class Ajax extends Backend
{
    ...
    {
        $provincelist = Db::name('province')->field('code as value,name')->order('code asc')->select();
        $this->success('', null, $provincelist);
    }
    ...
    {
        $pid = $this->request->get('pid');
        $where['provinceCode'] = ['=', $pid];
        $citylist = Db::name('city')->where($where)->field('code as value,name')->order('code asc')->select();
